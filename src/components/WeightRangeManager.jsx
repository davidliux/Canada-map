...
const WeightRangeManager = ({ 
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      ...
      {/* 重量区间列表 */}
      <div className="max-h-[600px] overflow-y-auto space-y-3 pr-2 scrollbar-thin scrollbar-thumb-cyber-blue/30 scrollbar-track-transparent">
        <AnimatePresence>
        ...
        {ranges.length === 0 && (
          <div className="p-8 text-center text-gray-400">
            ...
            <p>暂无价格区间配置</p>
            {!readOnly && <p className="text-sm mt-2">点击下方"添加重量区间"开始配置</p>}
          </div>
        )}
      </div>
