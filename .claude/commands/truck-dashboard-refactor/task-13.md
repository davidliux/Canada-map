# truck-dashboard-refactor - Task 13

Execute task 13 for the truck-dashboard-refactor specification.
...
## Usage
```
/Task:13-truck-dashboard-refactor
```
...
```
Use the @spec-task-executor agent to implement task 13: "更新路由配置" for the truck-dashboard-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 13: "更新路由配置"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-refactor 13 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-refactor 13 --mode complete
```
