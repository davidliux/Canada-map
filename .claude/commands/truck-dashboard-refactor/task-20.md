# truck-dashboard-refactor - Task 20

Execute task 20 for the truck-dashboard-refactor specification.
...
## Usage
```
/Task:20-truck-dashboard-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加数据缓存层"

```
Use the @spec-task-executor agent to implement task 20: "添加数据缓存层" for the truck-dashboard-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 20: "添加数据缓存层"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-refactor 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-refactor 20 --mode complete
```
