# truck-dashboard-refactor - Task 22

Execute task 22 for the truck-dashboard-refactor specification.
...
## Usage
```
/Task:22-truck-dashboard-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建集成测试"

```
Use the @spec-task-executor agent to implement task 22: "创建集成测试" for the truck-dashboard-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 22: "创建集成测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-refactor 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-refactor 22 --mode complete
```
