# truck-dashboard-refactor - Task 6

Execute task 6 for the truck-dashboard-refactor specification.
...
## Usage
```
/Task:6-truck-dashboard-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建卡车搜索服务"

```
Use the @spec-task-executor agent to implement task 6: "创建卡车搜索服务" for the truck-dashboard-refactor specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 创建卡车搜索服务
- Requirements: FR-008

## Instructions
- Implement ONLY task 6: "创建卡车搜索服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-refactor 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-refactor 6 --mode complete
```
