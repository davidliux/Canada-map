# truck-dashboard-refactor - Task 15

Execute task 15 for the truck-dashboard-refactor specification.
...
## Usage
```
/Task:15-truck-dashboard-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建数据适配器"

```
Use the @spec-task-executor agent to implement task 15: "创建数据适配器" for the truck-dashboard-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 15: "创建数据适配器"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-refactor 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-refactor 15 --mode complete
```
