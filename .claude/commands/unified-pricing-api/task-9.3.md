# unified-pricing-api - Task 9.3

Execute task 9.3 for the unified-pricing-api specification.
...
## Usage
```
/Task:9.3-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "更新卡车派送大屏"

```
Use the @spec-task-executor agent to implement task 9.3: "更新卡车派送大屏" for the unified-pricing-api specification and include all the below context.
...
## Task Details
- Task ID: 9.3
- Description: 更新卡车派送大屏
- Leverage: src/pages/TruckDelivery/Dashboard.jsx
- Requirements: 2.1

## Instructions
- Implement ONLY task 9.3: "更新卡车派送大屏"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 9.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 9.3 --mode complete
```
