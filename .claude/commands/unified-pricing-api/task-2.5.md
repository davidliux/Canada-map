# unified-pricing-api - Task 2.5

Execute task 2.5 for the unified-pricing-api specification.
...
## Usage
```
/Task:2.5-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建策略工厂"

```
Use the @spec-task-executor agent to implement task 2.5: "创建策略工厂" for the unified-pricing-api specification and include all the below context.
...
## Instructions
- Implement ONLY task 2.5: "创建策略工厂"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 2.5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 2.5 --mode complete
```
