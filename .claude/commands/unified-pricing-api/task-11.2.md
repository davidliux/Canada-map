# unified-pricing-api - Task 11.2

Execute task 11.2 for the unified-pricing-api specification.
...
## Usage
```
/Task:11.2-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建集成指南"

```
Use the @spec-task-executor agent to implement task 11.2: "创建集成指南" for the unified-pricing-api specification and include all the below context.
...
## Instructions
- Implement ONLY task 11.2: "创建集成指南"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 11.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 11.2 --mode complete
```
