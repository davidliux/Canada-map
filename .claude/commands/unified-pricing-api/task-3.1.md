# unified-pricing-api - Task 3.1

Execute task 3.1 for the unified-pricing-api specification.
...
## Usage
```
/Task:3.1-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现配置加载器"

```
Use the @spec-task-executor agent to implement task 3.1: "实现配置加载器" for the unified-pricing-api specification and include all the below context.
...
## Instructions
- Implement ONLY task 3.1: "实现配置加载器"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 3.1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 3.1 --mode complete
```
