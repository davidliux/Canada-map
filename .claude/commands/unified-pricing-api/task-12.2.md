# unified-pricing-api - Task 12.2

Execute task 12.2 for the unified-pricing-api specification.
...
## Usage
```
/Task:12.2-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建部署脚本"

```
Use the @spec-task-executor agent to implement task 12.2: "创建部署脚本" for the unified-pricing-api specification and include all the below context.
...
## Instructions
- Implement ONLY task 12.2: "创建部署脚本"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 12.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 12.2 --mode complete
```
