# unified-pricing-api - Task 4.3

Execute task 4.3 for the unified-pricing-api specification.
...
## Usage
```
/Task:4.3-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建配置查询路由"

```
Use the @spec-task-executor agent to implement task 4.3: "创建配置查询路由" for the unified-pricing-api specification and include all the below context.
...
## Task Details
- Task ID: 4.3
- Description: 创建配置查询路由
- Requirements: 5.1

## Instructions
- Implement ONLY task 4.3: "创建配置查询路由"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 4.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 4.3 --mode complete
```
