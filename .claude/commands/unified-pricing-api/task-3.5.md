# unified-pricing-api - Task 3.5

Execute task 3.5 for the unified-pricing-api specification.
...
## Usage
```
/Task:3.5-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现参数验证工具"

```
Use the @spec-task-executor agent to implement task 3.5: "实现参数验证工具" for the unified-pricing-api specification and include all the below context.
...
## Task Details
- Task ID: 3.5
- Description: 实现参数验证工具
- Requirements: 3.3, 3.4

## Instructions
- Implement ONLY task 3.5: "实现参数验证工具"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 3.5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 3.5 --mode complete
```
