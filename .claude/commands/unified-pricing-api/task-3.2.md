# unified-pricing-api - Task 3.2

Execute task 3.2 for the unified-pricing-api specification.
...
## Usage
```
/Task:3.2-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现缓存服务"

```
Use the @spec-task-executor agent to implement task 3.2: "实现缓存服务" for the unified-pricing-api specification and include all the below context.
...
## Instructions
- Implement ONLY task 3.2: "实现缓存服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 3.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 3.2 --mode complete
```
