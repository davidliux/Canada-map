# unified-pricing-api - Task 12.1

Execute task 12.1 for the unified-pricing-api specification.
...
## Usage
```
/Task:12.1-unified-pricing-api
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建数据迁移脚本"

```
Use the @spec-task-executor agent to implement task 12.1: "创建数据迁移脚本" for the unified-pricing-api specification and include all the below context.
...
## Task Details
- Task ID: 12.1
- Description: 创建数据迁移脚本
- Requirements: 12.1

## Instructions
- Implement ONLY task 12.1: "创建数据迁移脚本"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks unified-pricing-api 12.1 --mode complete
...
```bash
claude-code-spec-workflow get-tasks unified-pricing-api 12.1 --mode complete
```
