# dynamic-pricing-config - Task 33

Execute task 33 for the dynamic-pricing-config specification.

## Task Description
Create Price Breakdown Component

## Code Reuse
**Leverage existing code**: accordion pattern for details
...
## Usage
```
/Task:33-dynamic-pricing-config
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create Price Breakdown Component"

```
Use the @spec-task-executor agent to implement task 33: "Create Price Breakdown Component" for the dynamic-pricing-config specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create Price Breakdown Component
- Leverage: accordion pattern for details
- Requirements: 3.4

## Instructions
- Implement ONLY task 33: "Create Price Breakdown Component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dynamic-pricing-config 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dynamic-pricing-config 33 --mode complete
```
