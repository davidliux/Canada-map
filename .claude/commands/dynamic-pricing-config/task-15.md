# dynamic-pricing-config - Task 15

Execute task 15 for the dynamic-pricing-config specification.

## Task Description
Implement Increment Calculator

## Code Reuse
**Leverage existing code**: support fixed, percentage, tiered
...
## Usage
```
/Task:15-dynamic-pricing-config
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement Increment Calculator"

```
Use the @spec-task-executor agent to implement task 15: "Implement Increment Calculator" for the dynamic-pricing-config specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Implement Increment Calculator
- Leverage: support fixed, percentage, tiered
- Requirements: 3.2

## Instructions
- Implement ONLY task 15: "Implement Increment Calculator"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks dynamic-pricing-config 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks dynamic-pricing-config 15 --mode complete
```
