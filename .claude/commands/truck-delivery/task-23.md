# truck-delivery - Task 23

Execute task 23 for the truck-delivery specification.

## Task Description
Create CityRegionEditor component

## Code Reuse
**Leverage existing code**: React hooks for state
...
## Usage
```
/Task:23-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create CityRegionEditor component"

```
Use the @spec-task-executor agent to implement task 23: "Create CityRegionEditor component" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create CityRegionEditor component
- Leverage: React hooks for state
- Requirements: US-002

## Instructions
- Implement ONLY task 23: "Create CityRegionEditor component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 23 --mode complete
```
