# truck-delivery - Task 32

Execute task 32 for the truck-delivery specification.

## Task Description
Implement region color calculation
...
## Usage
```
/Task:32-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement region color calculation"

```
Use the @spec-task-executor agent to implement task 32: "Implement region color calculation" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 32
- Description: Implement region color calculation
- Leverage: None
- Requirements: US-004

## Instructions
- Implement ONLY task 32: "Implement region color calculation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 32 --mode complete
```
