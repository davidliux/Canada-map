# truck-delivery - Task 38

Execute task 38 for the truck-delivery specification.

## Task Description
Create truck price calculator service
...
## Usage
```
/Task:38-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create truck price calculator service"

```
Use the @spec-task-executor agent to implement task 38: "Create truck price calculator service" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 38
- Description: Create truck price calculator service
- Leverage: None
- Requirements: US-003

## Instructions
- Implement ONLY task 38: "Create truck price calculator service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 38 --mode complete
```
