# truck-delivery - Task 40

Execute task 40 for the truck-delivery specification.

## Task Description
Add bulk price calculation

## Code Reuse
**Leverage existing code**: Array.map()
...
## Usage
```
/Task:40-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add bulk price calculation"

```
Use the @spec-task-executor agent to implement task 40: "Add bulk price calculation" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 40
- Description: Add bulk price calculation
- Leverage: Array.map()
- Requirements: US-003

## Instructions
- Implement ONLY task 40: "Add bulk price calculation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 40 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 40 --mode complete
```
