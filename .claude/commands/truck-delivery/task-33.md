# truck-delivery - Task 33

Execute task 33 for the truck-delivery specification.

## Task Description
Create TruckPriceTable component
...
## Usage
```
/Task:33-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create TruckPriceTable component"

```
Use the @spec-task-executor agent to implement task 33: "Create TruckPriceTable component" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create TruckPriceTable component
- Leverage: DEFAULT
- Requirements: US-003

## Instructions
- Implement ONLY task 33: "Create TruckPriceTable component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 33 --mode complete
```
