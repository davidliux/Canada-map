# truck-delivery - Task 25

Execute task 25 for the truck-delivery specification.

## Task Description
Add region level selector
...
## Usage
```
/Task:25-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add region level selector"

```
Use the @spec-task-executor agent to implement task 25: "Add region level selector" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Add region level selector
- Leverage: None
- Requirements: US-002

## Instructions
- Implement ONLY task 25: "Add region level selector"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 25 --mode complete
```
