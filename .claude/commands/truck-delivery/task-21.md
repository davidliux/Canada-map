# truck-delivery - Task 21

Execute task 21 for the truck-delivery specification.

## Task Description
Add city deletion with confirmation
...
## Usage
```
/Task:21-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add city deletion with confirmation"

```
Use the @spec-task-executor agent to implement task 21: "Add city deletion with confirmation" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 21
- Description: Add city deletion with confirmation
- Leverage: None
- Requirements: US-001

## Instructions
- Implement ONLY task 21: "Add city deletion with confirmation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 21 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 21 --mode complete
```
