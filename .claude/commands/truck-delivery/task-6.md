# truck-delivery - Task 6

Execute task 6 for the truck-delivery specification.

## Task Description
Define truck delivery data types

## Code Reuse
**Leverage existing code**: Existing region data structures
...
## Usage
```
/Task:6-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Define truck delivery data types"

```
Use the @spec-task-executor agent to implement task 6: "Define truck delivery data types" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Define truck delivery data types
- Leverage: Existing region data structures
- Requirements: US-001, US-002

## Instructions
- Implement ONLY task 6: "Define truck delivery data types"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 6 --mode complete
```
