# truck-delivery - Task 35

Execute task 35 for the truck-delivery specification.

## Task Description
Add price validation

## Code Reuse
**Leverage existing code**: ValidationError from errorHandler.js
...
## Usage
```
/Task:35-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add price validation"

```
Use the @spec-task-executor agent to implement task 35: "Add price validation" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 35
- Description: Add price validation
- Leverage: ValidationError from errorHandler.js
- Requirements: US-003

## Instructions
- Implement ONLY task 35: "Add price validation"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 35 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 35 --mode complete
```
