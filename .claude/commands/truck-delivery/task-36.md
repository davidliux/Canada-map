# truck-delivery - Task 36

Execute task 36 for the truck-delivery specification.

## Task Description
Create RegionPriceManager for truck delivery

## Code Reuse
**Leverage existing code**: Existing RegionPriceManager patterns
...
## Usage
```
/Task:36-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create RegionPriceManager for truck delivery"

```
Use the @spec-task-executor agent to implement task 36: "Create RegionPriceManager for truck delivery" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 36
- Description: Create RegionPriceManager for truck delivery
- Leverage: Existing RegionPriceManager patterns
- Requirements: US-003

## Instructions
- Implement ONLY task 36: "Create RegionPriceManager for truck delivery"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 36 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 36 --mode complete
```
