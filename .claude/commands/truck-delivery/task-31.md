# truck-delivery - Task 31

Execute task 31 for the truck-delivery specification.

## Task Description
Add region validation before save

## Code Reuse
**Leverage existing code**: errorHandler.js classes
...
## Usage
```
/Task:31-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add region validation before save"

```
Use the @spec-task-executor agent to implement task 31: "Add region validation before save" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 31
- Description: Add region validation before save
- Leverage: errorHandler.js classes
- Requirements: US-002

## Instructions
- Implement ONLY task 31: "Add region validation before save"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 31 --mode complete
```
