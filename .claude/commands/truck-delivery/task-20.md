# truck-delivery - Task 20

Execute task 20 for the truck-delivery specification.

## Task Description
Connect CityManager to storage service

## Code Reuse
**Leverage existing code**: cityStorage service methods
...
## Usage
```
/Task:20-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Connect CityManager to storage service"

```
Use the @spec-task-executor agent to implement task 20: "Connect CityManager to storage service" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Connect CityManager to storage service
- Leverage: cityStorage service methods
- Requirements: US-001

## Instructions
- Implement ONLY task 20: "Connect CityManager to storage service"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 20 --mode complete
```
