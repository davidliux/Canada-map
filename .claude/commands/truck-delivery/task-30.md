# truck-delivery - Task 30

Execute task 30 for the truck-delivery specification.

## Task Description
Connect region editor to city data

## Code Reuse
**Leverage existing code**: cityStorage.saveCity()
...
## Usage
```
/Task:30-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Connect region editor to city data"

```
Use the @spec-task-executor agent to implement task 30: "Connect region editor to city data" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 30
- Description: Connect region editor to city data
- Leverage: cityStorage.saveCity()
- Requirements: US-002

## Instructions
- Implement ONLY task 30: "Connect region editor to city data"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 30 --mode complete
```
