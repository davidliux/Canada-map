# truck-delivery - Task 39

Execute task 39 for the truck-delivery specification.

## Task Description
Implement findPriceByWeight method

## Code Reuse
**Leverage existing code**: Array.find()
...
## Usage
```
/Task:39-truck-delivery
```

## Instructions

Execute with @spec-task-executor agent the following task: "Implement findPriceByWeight method"

```
Use the @spec-task-executor agent to implement task 39: "Implement findPriceByWeight method" for the truck-delivery specification and include all the below context.
...
## Task Details
- Task ID: 39
- Description: Implement findPriceByWeight method
- Leverage: Array.find()
- Requirements: US-003

## Instructions
- Implement ONLY task 39: "Implement findPriceByWeight method"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-delivery 39 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-delivery 39 --mode complete
```
