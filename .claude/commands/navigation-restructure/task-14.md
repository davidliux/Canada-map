# navigation-restructure - Task 14

Execute task 14 for the navigation-restructure specification.

## Task Description
Move Dashboard to FSADashboard

## Code Reuse
**Leverage existing code**: Entire existing Dashboard component
...
Execute with @spec-task-executor agent the following task: "Move Dashboard to FSADashboard"

```
Use the @spec-task-executor agent to implement task 14: "Move Dashboard to FSADashboard" for the navigation-restructure specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Move Dashboard to FSADashboard
- Leverage: Entire existing Dashboard component
- Requirements: US-001

## Instructions
- Implement ONLY task 14: "Move Dashboard to FSADashboard"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 14 --mode complete
```
