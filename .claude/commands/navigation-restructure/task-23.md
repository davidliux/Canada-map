# navigation-restructure - Task 23

Execute task 23 for the navigation-restructure specification.

## Task Description
Move PriceSettings to FSA management
...
## Usage
```
/Task:23-navigation-restructure
```

## Instructions

Execute with @spec-task-executor agent the following task: "Move PriceSettings to FSA management"

```
Use the @spec-task-executor agent to implement task 23: "Move PriceSettings to FSA management" for the navigation-restructure specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Move PriceSettings to FSA management
- Leverage: Existing component logic
- Requirements: US-002

## Instructions
- Implement ONLY task 23: "Move PriceSettings to FSA management"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 23 --mode complete
```
