# navigation-restructure - Task 25

Execute task 25 for the navigation-restructure specification.

## Task Description
Style dashboard hub cards

## Code Reuse
**Leverage existing code**: Existing card styles from TruckDelivery
...
## Usage
```
/Task:25-navigation-restructure
```

## Instructions

Execute with @spec-task-executor agent the following task: "Style dashboard hub cards"

```
Use the @spec-task-executor agent to implement task 25: "Style dashboard hub cards" for the navigation-restructure specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Style dashboard hub cards
- Leverage: Existing card styles from TruckDelivery
- Requirements: US-005

## Instructions
- Implement ONLY task 25: "Style dashboard hub cards"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 25 --mode complete
```
