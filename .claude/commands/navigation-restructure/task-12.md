# navigation-restructure - Task 12

Execute task 12 for the navigation-restructure specification.

## Task Description
Integrate breadcrumb into MainLayout
...
## Usage
```
/Task:12-navigation-restructure
```

## Instructions

Execute with @spec-task-executor agent the following task: "Integrate breadcrumb into MainLayout"

```
Use the @spec-task-executor agent to implement task 12: "Integrate breadcrumb into MainLayout" for the navigation-restructure specification and include all the below context.
...
## Task Details
- Task ID: 12
- Description: Integrate breadcrumb into MainLayout
- Leverage: Existing layout structure
- Requirements: US-003

## Instructions
- Implement ONLY task 12: "Integrate breadcrumb into MainLayout"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 12 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 12 --mode complete
```
