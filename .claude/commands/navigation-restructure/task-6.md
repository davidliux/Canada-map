# navigation-restructure - Task 6

Execute task 6 for the navigation-restructure specification.

## Task Description
Add new route paths for management module

## Code Reuse
**Leverage existing code**: Existing nested routing pattern

## Requirements Reference
**Requirements**: US-002, US-003
...
Execute with @spec-task-executor agent the following task: "Add new route paths for management module"

```
Use the @spec-task-executor agent to implement task 6: "Add new route paths for management module" for the navigation-restructure specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Add new route paths for management module
- Leverage: Existing nested routing pattern
- Requirements: US-002, US-003

## Instructions
- Implement ONLY task 6: "Add new route paths for management module"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 6 --mode complete
```
