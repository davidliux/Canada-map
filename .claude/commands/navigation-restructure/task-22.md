# navigation-restructure - Task 22

Execute task 22 for the navigation-restructure specification.

## Task Description
Move RegionSettings to FSA management

## Code Reuse
**Leverage existing code**: Existing component logic
...
## Usage
```
/Task:22-navigation-restructure
```

## Instructions

Execute with @spec-task-executor agent the following task: "Move RegionSettings to FSA management"

```
Use the @spec-task-executor agent to implement task 22: "Move RegionSettings to FSA management" for the navigation-restructure specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: Move RegionSettings to FSA management
- Leverage: Existing component logic
- Requirements: US-002

## Instructions
- Implement ONLY task 22: "Move RegionSettings to FSA management"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 22 --mode complete
```
