# navigation-restructure - Task 11

Execute task 11 for the navigation-restructure specification.

## Task Description
Add breadcrumb navigation component

## Code Reuse
**Leverage existing code**: useLocation hook from react-router-dom
...
## Usage
```
/Task:11-navigation-restructure
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add breadcrumb navigation component"

```
Use the @spec-task-executor agent to implement task 11: "Add breadcrumb navigation component" for the navigation-restructure specification and include all the below context.
...
- Leverage: useLocation hook from react-router-dom
- Requirements: US-003

## Instructions
- Implement ONLY task 11: "Add breadcrumb navigation component"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks navigation-restructure 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks navigation-restructure 11 --mode complete
```
