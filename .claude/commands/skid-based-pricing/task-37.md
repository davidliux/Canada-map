# skid-based-pricing - Task 37

Execute task 37 for the skid-based-pricing specification.

## Task Description
Create migration utility in src/utils/migration/skidPricingMigration.js

## Code Reuse
**Leverage existing code**: src/services/pricingMigrationService.js
...
## Usage
```
/Task:37-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create migration utility in src/utils/migration/skidPricingMigration.js"

```
Use the @spec-task-executor agent to implement task 37: "Create migration utility in src/utils/migration/skidPricingMigration.js" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 37
- Description: Create migration utility in src/utils/migration/skidPricingMigration.js
- Leverage: src/services/pricingMigrationService.js
- Requirements: 1.1

## Instructions
- Implement ONLY task 37: "Create migration utility in src/utils/migration/skidPricingMigration.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 37 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 37 --mode complete
```
