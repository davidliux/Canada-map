# skid-based-pricing - Task 10

Execute task 10 for the skid-based-pricing specification.

## Task Description
Create accessorial charge manager in src/utils/pricing/accessorialManager.js

## Code Reuse
**Leverage existing code**: src/utils/quotationGenerator.js patterns
...
## Usage
```
/Task:10-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create accessorial charge manager in src/utils/pricing/accessorialManager.js"

```
Use the @spec-task-executor agent to implement task 10: "Create accessorial charge manager in src/utils/pricing/accessorialManager.js" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Create accessorial charge manager in src/utils/pricing/accessorialManager.js
- Leverage: src/utils/quotationGenerator.js patterns
- Requirements: 4.1, 4.2

## Instructions
- Implement ONLY task 10: "Create accessorial charge manager in src/utils/pricing/accessorialManager.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 10 --mode complete
```
