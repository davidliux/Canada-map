# skid-based-pricing - Task 25

Execute task 25 for the skid-based-pricing specification.

## Task Description
Create accessorial config component in src/components/pricing/skid/AccessorialConfig.jsx

## Code Reuse
**Leverage existing code**: src/components/WeightRangeManager.jsx UI patterns
...
## Usage
```
/Task:25-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create accessorial config component in src/components/pricing/skid/AccessorialConfig.jsx"

```
Use the @spec-task-executor agent to implement task 25: "Create accessorial config component in src/components/pricing/skid/AccessorialConfig.jsx" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 25
- Description: Create accessorial config component in src/components/pricing/skid/AccessorialConfig.jsx
- Leverage: src/components/WeightRangeManager.jsx UI patterns
- Requirements: 4.1

## Instructions
- Implement ONLY task 25: "Create accessorial config component in src/components/pricing/skid/AccessorialConfig.jsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 25 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 25 --mode complete
```
