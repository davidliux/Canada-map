# skid-based-pricing - Task 6

Execute task 6 for the skid-based-pricing specification.

## Task Description
Add zone price calculation to skidCalculator.js

## Code Reuse
**Leverage existing code**: existing calculatePrice method
...
## Usage
```
/Task:6-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add zone price calculation to skidCalculator.js"

```
Use the @spec-task-executor agent to implement task 6: "Add zone price calculation to skidCalculator.js" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: Add zone price calculation to skidCalculator.js
- Leverage: existing calculatePrice method
- Requirements: 2.1, 2.5

## Instructions
- Implement ONLY task 6: "Add zone price calculation to skidCalculator.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 6 --mode complete
```
