# skid-based-pricing - Task 26

Execute task 26 for the skid-based-pricing specification.

## Task Description
Add charge value inputs in AccessorialConfig.jsx
...
## Usage
```
/Task:26-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add charge value inputs in AccessorialConfig.jsx"

```
Use the @spec-task-executor agent to implement task 26: "Add charge value inputs in AccessorialConfig.jsx" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 26
- Description: Add charge value inputs in AccessorialConfig.jsx
- Requirements: 4.2

## Instructions
- Implement ONLY task 26: "Add charge value inputs in AccessorialConfig.jsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 26 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 26 --mode complete
```
