# skid-based-pricing - Task 23

Execute task 23 for the skid-based-pricing specification.

## Task Description
Create zone selector component in src/components/pricing/skid/SkidZoneSelector.jsx

## Code Reuse
**Leverage existing code**: src/components/pricing/CityRegionSelector.jsx
...
## Usage
```
/Task:23-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create zone selector component in src/components/pricing/skid/SkidZoneSelector.jsx"

```
Use the @spec-task-executor agent to implement task 23: "Create zone selector component in src/components/pricing/skid/SkidZoneSelector.jsx" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 23
- Description: Create zone selector component in src/components/pricing/skid/SkidZoneSelector.jsx
- Leverage: src/components/pricing/CityRegionSelector.jsx
- Requirements: 2.1, 2.2

## Instructions
- Implement ONLY task 23: "Create zone selector component in src/components/pricing/skid/SkidZoneSelector.jsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 23 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 23 --mode complete
```
