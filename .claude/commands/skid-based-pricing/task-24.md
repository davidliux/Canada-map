# skid-based-pricing - Task 24

Execute task 24 for the skid-based-pricing specification.

## Task Description
Add zone status indicators in SkidZoneSelector.jsx
...
## Usage
```
/Task:24-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add zone status indicators in SkidZoneSelector.jsx"

```
Use the @spec-task-executor agent to implement task 24: "Add zone status indicators in SkidZoneSelector.jsx" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 24
- Description: Add zone status indicators in SkidZoneSelector.jsx
- Requirements: 2.3

## Instructions
- Implement ONLY task 24: "Add zone status indicators in SkidZoneSelector.jsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 24 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 24 --mode complete
```
