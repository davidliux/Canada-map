# skid-based-pricing - Task 33

Execute task 33 for the skid-based-pricing specification.

## Task Description
Create price calculator component in src/components/pricing/skid/SkidPriceCalculator.jsx

## Code Reuse
**Leverage existing code**: src/components/cities/PriceCalculatorDemo.jsx
...
## Usage
```
/Task:33-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create price calculator component in src/components/pricing/skid/SkidPriceCalculator.jsx"

```
Use the @spec-task-executor agent to implement task 33: "Create price calculator component in src/components/pricing/skid/SkidPriceCalculator.jsx" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 33
- Description: Create price calculator component in src/components/pricing/skid/SkidPriceCalculator.jsx
- Leverage: src/components/cities/PriceCalculatorDemo.jsx
- Requirements: 5.1, 5.2

## Instructions
- Implement ONLY task 33: "Create price calculator component in src/components/pricing/skid/SkidPriceCalculator.jsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 33 --mode complete
```
