# skid-based-pricing - Task 34

Execute task 34 for the skid-based-pricing specification.

## Task Description
Add accessorial charge selection in SkidPriceCalculator.jsx
...
## Usage
```
/Task:34-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add accessorial charge selection in SkidPriceCalculator.jsx"

```
Use the @spec-task-executor agent to implement task 34: "Add accessorial charge selection in SkidPriceCalculator.jsx" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 34
- Description: Add accessorial charge selection in SkidPriceCalculator.jsx
- Requirements: 5.4

## Instructions
- Implement ONLY task 34: "Add accessorial charge selection in SkidPriceCalculator.jsx"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 34 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 34 --mode complete
```
