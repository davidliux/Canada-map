# skid-based-pricing - Task 45

Execute task 45 for the skid-based-pricing specification.

## Task Description
Add virtual scrolling to SkidPricingMatrix for large datasets

## Requirements Reference
**Requirements**: Performance - < 2s load time

## Usage
```
/Task:45-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add virtual scrolling to SkidPricingMatrix for large datasets"

```
Use the @spec-task-executor agent to implement task 45: "Add virtual scrolling to SkidPricingMatrix for large datasets" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 45
- Description: Add virtual scrolling to SkidPricingMatrix for large datasets
- Requirements: Performance - < 2s load time

## Instructions
- Implement ONLY task 45: "Add virtual scrolling to SkidPricingMatrix for large datasets"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 45 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 45 --mode complete
```
