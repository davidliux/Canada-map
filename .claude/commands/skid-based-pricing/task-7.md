# skid-based-pricing - Task 7

Execute task 7 for the skid-based-pricing specification.

## Task Description
Add incremental pricing for 16+ skids in skidCalculator.js

## Code Reuse
**Leverage existing code**: existing calculation patterns
...
## Usage
```
/Task:7-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add incremental pricing for 16+ skids in skidCalculator.js"

```
Use the @spec-task-executor agent to implement task 7: "Add incremental pricing for 16+ skids in skidCalculator.js" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: Add incremental pricing for 16+ skids in skidCalculator.js
- Leverage: existing calculation patterns
- Requirements: 1.4

## Instructions
- Implement ONLY task 7: "Add incremental pricing for 16+ skids in skidCalculator.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 7 --mode complete
```
