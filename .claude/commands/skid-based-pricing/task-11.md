# skid-based-pricing - Task 11

Execute task 11 for the skid-based-pricing specification.

## Task Description
Add charge calculation methods to accessorialManager.js
...
## Usage
```
/Task:11-skid-based-pricing
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add charge calculation methods to accessorialManager.js"

```
Use the @spec-task-executor agent to implement task 11: "Add charge calculation methods to accessorialManager.js" for the skid-based-pricing specification and include all the below context.
...
## Task Details
- Task ID: 11
- Description: Add charge calculation methods to accessorialManager.js
- Requirements: 4.2, 4.3

## Instructions
- Implement ONLY task 11: "Add charge calculation methods to accessorialManager.js"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks skid-based-pricing 11 --mode complete
...
```bash
claude-code-spec-workflow get-tasks skid-based-pricing 11 --mode complete
```
