# truck-dashboard-layout-refactor - Task 32

Execute task 32 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:32-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "清理旧代码"

```
Use the @spec-task-executor agent to implement task 32: "清理旧代码" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 32: "清理旧代码"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 32 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 32 --mode complete
```
