# truck-dashboard-layout-refactor - Task 6

Execute task 6 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:6-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "实现区域卡片展开动画"

```
Use the @spec-task-executor agent to implement task 6: "实现区域卡片展开动画" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 6
- Description: 实现区域卡片展开动画
- Requirements: NFR-002

## Instructions
- Implement ONLY task 6: "实现区域卡片展开动画"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 6 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 6 --mode complete
```
