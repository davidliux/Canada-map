# truck-dashboard-layout-refactor - Task 20

Execute task 20 for the truck-dashboard-layout-refactor specification.

## Task Description
迁移现有数据获取逻辑

## Code Reuse
**Leverage existing code**: src/services/truckDeliveryApi.js

## Requirements Reference
**Requirements**: 设计2.3.1

## Usage
```
/Task:20-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "迁移现有数据获取逻辑"

```
Use the @spec-task-executor agent to implement task 20: "迁移现有数据获取逻辑" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: 迁移现有数据获取逻辑
- Leverage: src/services/truckDeliveryApi.js
- Requirements: 设计2.3.1

## Instructions
- Implement ONLY task 20: "迁移现有数据获取逻辑"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 20 --mode complete
```
