# truck-dashboard-layout-refactor - Task 31

Execute task 31 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:31-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "功能集成测试"

```
Use the @spec-task-executor agent to implement task 31: "功能集成测试" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 31: "功能集成测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 31 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 31 --mode complete
```
