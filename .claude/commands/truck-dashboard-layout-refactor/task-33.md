# truck-dashboard-layout-refactor - Task 33

Execute task 33 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:33-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加功能开关"

```
Use the @spec-task-executor agent to implement task 33: "添加功能开关" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 33: "添加功能开关"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 33 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 33 --mode complete
```
