# truck-dashboard-layout-refactor - Task 19

Execute task 19 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:19-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "集成Context Provider"

```
Use the @spec-task-executor agent to implement task 19: "集成Context Provider" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 19
- Description: 集成Context Provider
- Requirements: 设计2.2.1

## Instructions
- Implement ONLY task 19: "集成Context Provider"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 19 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 19 --mode complete
```
