# truck-dashboard-layout-refactor - Task 5

Execute task 5 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:5-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建区域卡片组件"

```
Use the @spec-task-executor agent to implement task 5: "创建区域卡片组件" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 5
- Description: 创建区域卡片组件
- Requirements: FR-012, FR-013

## Instructions
- Implement ONLY task 5: "创建区域卡片组件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 5 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 5 --mode complete
```
