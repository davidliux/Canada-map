# truck-dashboard-layout-refactor - Task 8

Execute task 8 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:8-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建FSA代码芯片组件"

```
Use the @spec-task-executor agent to implement task 8: "创建FSA代码芯片组件" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 8
- Description: 创建FSA代码芯片组件
- Requirements: FR-015

## Instructions
- Implement ONLY task 8: "创建FSA代码芯片组件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 8 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 8 --mode complete
```
