# truck-dashboard-layout-refactor - Task 29

Execute task 29 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:29-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "集成错误处理"

```
Use the @spec-task-executor agent to implement task 29: "集成错误处理" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 29: "集成错误处理"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 29 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 29 --mode complete
```
