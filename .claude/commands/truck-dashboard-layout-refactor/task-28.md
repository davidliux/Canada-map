# truck-dashboard-layout-refactor - Task 28

Execute task 28 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:28-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建加载和空状态组件"

```
Use the @spec-task-executor agent to implement task 28: "创建加载和空状态组件" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 28
- Description: 创建加载和空状态组件
- Requirements: 设计4.2

## Instructions
- Implement ONLY task 28: "创建加载和空状态组件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 28 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 28 --mode complete
```
