# truck-dashboard-layout-refactor - Task 22

Execute task 22 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:22-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加暗色主题样式"

```
Use the @spec-task-executor agent to implement task 22: "添加暗色主题样式" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 22
- Description: 添加暗色主题样式
- Requirements: NFR-007

## Instructions
- Implement ONLY task 22: "添加暗色主题样式"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 22 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 22 --mode complete
```
