# truck-dashboard-layout-refactor - Task 14

Execute task 14 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:14-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建自定义Hooks"

```
Use the @spec-task-executor agent to implement task 14: "创建自定义Hooks" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: 创建自定义Hooks
- Requirements: 设计2.5.2

## Instructions
- Implement ONLY task 14: "创建自定义Hooks"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 14 --mode complete
```
