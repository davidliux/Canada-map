# truck-dashboard-layout-refactor - Task 30

Execute task 30 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:30-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "编写单元测试"

```
Use the @spec-task-executor agent to implement task 30: "编写单元测试" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Instructions
- Implement ONLY task 30: "编写单元测试"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 30 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 30 --mode complete
```
