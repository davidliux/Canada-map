# truck-dashboard-layout-refactor - Task 7

Execute task 7 for the truck-dashboard-layout-refactor specification.
...
## Usage
```
/Task:7-truck-dashboard-layout-refactor
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建FSA分组列表组件"

```
Use the @spec-task-executor agent to implement task 7: "创建FSA分组列表组件" for the truck-dashboard-layout-refactor specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: 创建FSA分组列表组件
- Requirements: FR-014, FR-015

## Instructions
- Implement ONLY task 7: "创建FSA分组列表组件"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-dashboard-layout-refactor 7 --mode complete
```
