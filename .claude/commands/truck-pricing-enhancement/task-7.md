# truck-pricing-enhancement - Task 7

Execute task 7 for the truck-pricing-enhancement specification.
...
## Usage
```
/Task:7-truck-pricing-enhancement
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建价格计算服务"

```
Use the @spec-task-executor agent to implement task 7: "创建价格计算服务" for the truck-pricing-enhancement specification and include all the below context.
...
## Task Details
- Task ID: 7
- Description: 创建价格计算服务
- Leverage: backend/src/routes/skidPricing.js
- Requirements: 5

## Instructions
- Implement ONLY task 7: "创建价格计算服务"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-pricing-enhancement 7 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-pricing-enhancement 7 --mode complete
```
