# truck-pricing-enhancement - Task 14

Execute task 14 for the truck-pricing-enhancement specification.
...
## Usage
```
/Task:14-truck-pricing-enhancement
```

## Instructions

Execute with @spec-task-executor agent the following task: "添加价格计算方法"

```
Use the @spec-task-executor agent to implement task 14: "添加价格计算方法" for the truck-pricing-enhancement specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: 添加价格计算方法
- Leverage: src/services/pricingService.js
- Requirements: 5

## Instructions
- Implement ONLY task 14: "添加价格计算方法"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-pricing-enhancement 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-pricing-enhancement 14 --mode complete
```
