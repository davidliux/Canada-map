# truck-pricing-enhancement - Task 38

Execute task 38 for the truck-pricing-enhancement specification.
...
## Usage
```
/Task:38-truck-pricing-enhancement
```

## Instructions

Execute with @spec-task-executor agent the following task: "创建导入功能"

```
Use the @spec-task-executor agent to implement task 38: "创建导入功能" for the truck-pricing-enhancement specification and include all the below context.
...
## Instructions
- Implement ONLY task 38: "创建导入功能"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks truck-pricing-enhancement 38 --mode complete
...
```bash
claude-code-spec-workflow get-tasks truck-pricing-enhancement 38 --mode complete
```
